...
<link rel="stylesheet" type="text/css" href="{link path="/"}themes/Cube/design/steam/enable.css" media="all" />
{literal}
<style type="text/css">
/* Abi */
...
-->
					...
					{steamcats_link}
					{steamactivity_link}
            		<li class="active"><i class="icon-shop"></i><a class="demarket" href="http://www.teckroom.com/market">Market</a>
					...
					<li class="steamlogin"><i class="icon-user-add"></i><a href="{link path="entry/register"}" rel="nofollow">Join Us</a></li>
					{/if}
					</ul>
					</div>
<!-- End of Menu -->
...
<!-- Begin of Copyrights -->
	<div class="row footdw">
		<div class="row">
				...
				<div class="col-md-12 footercopy leftl">
				<span class="footcop">
			 <a href="http://teckroom.com/home/privacypolicy" color="white">Privacy Policy</a> <a href="http://www.teckroom.com/home/termsofservice" color="white">Terms Of Service</a>&nbsp;&nbsp;&nbsp;&nbsp;<br> ©Copyright 2015
...
<script src="{link path="/"}themes/Cube/jquery/icheck.min.js" type="text/javascript"></script>
<script src="{link path="/"}themes/Cube/jquery/ichecken.js" type="text/javascript"></script>
<script src="{link path="/"}themes/Cube/jquery/components.js" type="text/javascript"></script>

<!-- Ajax -->
<script src="{link path="/"}themes/Cube/jquery/viewportchecker.js" type="text/javascript"></script>
<script src="{link path="/"}themes/Cube/jquery/ajax.js" type="text/javascript"></script>
